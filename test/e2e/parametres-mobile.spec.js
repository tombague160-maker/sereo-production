...
const ARCHIVES = [
  { id: "a-3", type: "ventes", filename: "ventes-septembre-semaine-38.xlsx", importedAt: "2026-09-16T06:42:00Z", rowsCount: 38, fileSize: 20480, stats: { created: 5 } },
  { id: "a-2", type: "stock", filename: "stock.xlsx", importedAt: "2026-09-15T07:00:00Z", rowsCount: 20, fileSize: 8192, stats: { updated: 20 } },
  { id: "a-1", type: "ventes", filename: "ventes-septembre-semaine-37.xlsx", importedAt: "2026-09-09T07:00:00Z", rowsCount: 31, fileSize: 19000, stats: { created: 4 } }
];

async function ouvrir(page, { largeur = 390, schema = "light", moi = null } = {}) {
  const patchs = [];
...
for (const schema of ["light", "dark"]) {
  test(`en ${schema === "light" ? "clair" : "sombre"}, les textes des lignes et des feuilles tiennent 4,5:1`, async ({ page }) => {
    ...
    const mesure = () => page.evaluate(() => {
      ...
      const sel = "#comptesList .par-telephone .par-ligne-titre, #comptesList .par-telephone .par-ligne-meta, #comptesList .par-badge, .par-imports-lignes .par-ligne-titre, .par-imports-lignes .par-ligne-meta, #parCompteFeuille .par-aide, #parCompteFeuille .button";
