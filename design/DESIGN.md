...
| Vert d'eau | `#A1C4C0` | Surfaces secondaires, icônes inactives sur fond vert | — |
| Pêche | `#EDC8C3` | Fonds doux, badges tièdes, formes organiques en fond | — |
...
| Alerte | `#FF9478` → à valider, sinon `#F28B7A` | Mesurer sur `#132224` |
...
- **Badge de statut** : pilule 24 px, fond pêche ou vert d'eau, texte vert profond.
